        ...
        <div className="w-full md:w-[273px]  shrink-0 ">
            <div className="h-[182px] rounded-[15px] overflow-hidden relative">
                ...
                <div className="w-full h-full relative group overflow-hidden">
                    ...
                    <div className="w-full h-full relative transition-transform duration-300 transform group-hover:scale-110">
                        ...
                        <div className="absolute inset-0 flex items-end p-2 text-[16px] md:text-[20px] font-bold text-white tracking-tight z-10">
                            {props.offer}
                        </div>
